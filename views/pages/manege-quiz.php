<div class="wrap">
    ...
    <?php
        ...
        ?>
        <div class="question">
            <h2>Pergunta: <?php echo $question->dados->title ?> <a onClick="jQuery('#editquestion<?php echo $question->dados->id; ?>').removeClass('d-none'); jQuery(this).addClass('d-none')" class="page-title-action">Editar</a></h2>
